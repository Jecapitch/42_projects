...
- minishell (in collaboration with [Emerick-M](https://github.com/Emerick-M)): a simple bash-inspired shell, implementing variable expansion, pipes, redirections (< << > >>), escape sequences, and some builtins (cd, echo, env, exit, export, pwd, unset).
