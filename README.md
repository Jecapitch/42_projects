...
- push_swap : a sorting algorithm using two stacks and predefined operations. Here in 2 versions : radix sort in base 2 (complete with management of all cases [i.e. small list, already sorted but rotated list, reversely sorted list], the one I submitted) and base 3 (which was my first idea, but less efficient; case management incomplete).
