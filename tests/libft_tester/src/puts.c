...
/*   Updated: 2026/04/21 14:13:44 by jepiscic         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	char	*src;
	int		ft_fd = open("traces/"STRF(FT)"_user_output", O_CREAT | O_TRUNC | O_RDWR | O_APPEND);
	int		std_fd = open("traces/"STRF(FT)"_test_output", O_CREAT | O_TRUNC | O_RDWR | O_APPEND);
